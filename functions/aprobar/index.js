...
function getApprovalPage(orden, token) {
  ...
  html += 'canvas.addEventListener("pointerdown", function(e) { e.preventDefault(); startDraw(e); });';
  html += 'canvas.addEventListener("pointermove", function(e) { e.preventDefault(); moveDraw(e); });';
