...
export async function onRequestGet(context) {
  ...
  if (!token) {
    return new Response('Enlace invÃ¡lido. No se proporcionÃ³ token.', { status: 400 });
  }
    ...
    return new Response(`
      ...
      <body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-xl shadow-lg p-8 text-center max-w-md">
          ...
          <p class="text-gray-600">El enlace de la orden no es vÃ¡lido o ha expirado.</p>
          <p class="text-sm text-gray-500 mt-4">Contacte al taller para mÃ¡s informaciÃ³n.</p>
        </div>
      </body>
      </html>
    `, {
...
function generarHTMLAprobacion(orden) {
  ...
  let trabajosHtml = '';
  if (orden.trabajo_frenos) trabajosHtml += `<li class="flex items-start"><span class="text-green-500 mr-2">âœ“</span><span><strong>Frenos:</strong> ${orden.detalle_frenos || 'Sin detalle'}</span></li>`;
  if (orden.trabajo_luces) trabajosHtml += `<li class="flex items-start"><span class="text-green-500 mr-2">âœ“</span><span><strong>Luces:</strong> ${orden.detalle_luces || 'Sin detalle'}</span></li>`;
  if (orden.trabajo_tren_delantero) trabajosHtml += `<li class="flex items-start"><span class="text-green-500 mr-2">âœ“</span><span><strong>Tren Delantero:</strong> ${orden.detalle_tren_delantero || 'Sin detalle'}</span></li>`;
  if (orden.trabajo_correas) trabajosHtml += `<li class="flex items-start"><span class="text-green-500 mr-2">âœ“</span><span><strong>Correas:</strong> ${orden.detalle_correas || 'Sin detalle'}</span></li>`;
  if (orden.trabajo_componentes) trabajosHtml += `<li class="flex items-start"><span class="text-green-500 mr-2">âœ“</span><span><strong>Componentes:</strong> ${orden.detalle_componentes || 'Sin detalle'}</span></li>`;
...
<body class="p-4">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white shadow-2xl p-4 md:p-6">
            ...
            <div class="bg-gray-50 rounded-xl p-4 mb-6">
                <h3 class="font-bold text-lg mb-3 text-gray-800">ðŸ“‹ InformaciÃ³n de la Orden</h3>
                <div class="grid grid-cols-2 gap-3 text-sm">
                    <div>
                        <span class="text-gray-600">NÂ° Orden:</span>
                    ...
                    <div>
                        <span class="text-gray-600">TÃ©cnico:</span>
            ...
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-4 mb-6 text-white">
                <h3 class="font-bold text-lg mb-3">ðŸ’° Valores</h3>
            ...
            <div class="mb-6">
                <h3 class="font-bold text-lg mb-3 text-gray-800">ðŸ”§ Trabajos Seleccionados</h3>
            ...
            <!-- Datos del VehÃ­culo -->
            <div class="bg-gray-50 rounded-xl p-4 mb-6">
                <h3 class="font-bold text-lg mb-3 text-gray-800">ðŸš— Datos del VehÃ­culo</h3>
                <div class="grid grid-cols-2 gap-3 text-sm">
                    <div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6">
                <h3 class="font-bold text-lg mb-3 text-gray-800">âœ… Checklist del VehÃ­culo</h3>
                <div class="text-sm">
                    <p><strong>Nivel de Combustible:</strong> ${orden.nivel_combustible || 'No registrado'}</p>
                    <p class="mt-2"><strong>Estado de CarrocerÃ­a:</strong></p>
                    <ul class="mt-1 ml-4">
                        ${orden.check_paragolfe_delantero_der ? '<li>âœ“ Parachoques delantero derecho</li>' : ''}
                        ${orden.check_puerta_delantera_der ? '<li>âœ“ Puerta delantera derecha</li>' : ''}
                        ${orden.check_puerta_trasera_der ? '<li>âœ“ Puerta trasera derecha</li>' : ''}
                        ${orden.check_paragolfe_trasero_izq ? '<li>âœ“ Parachoques trasero izquierdo</li>' : ''}
            ...
            <!-- Ãrea de Firma -->
            <div class="mb-6">
                <h3 class="font-bold text-lg mb-3 text-gray-800">âœï¸ Firma para Aprobar</h3>
            ...
            <div class="bg-gray-100 rounded-lg p-4 mb-6 text-sm text-gray-700">
                ...
                <ul class="list-disc list-inside space-y-1">
                    <li>La intervenciÃ³n del vehÃ­culo</li>
    ...
    <script>
        ...
        async function aprobarOrden() {
            ...
            // Verificar si el canvas estÃ¡ vacÃ­o (simplificado)
            ...
            try {
                ...
                if (data.success) {
                    ...
                    btn.innerHTML = 'âœ… Aceptar y Firmar';
                    btn.disabled = false;
                }
            } catch (error) {
        ...
        async function cancelarOrden() {
            const motivo = prompt('Â¿CuÃ¡l es el motivo de la cancelaciÃ³n? (Opcional)');
            
            if (confirm('Â¿EstÃ¡ seguro de cancelar esta orden de trabajo?')) {
                try {
            ...
            return \`
                ...
                <body class="bg-green-100 flex items-center justify-center min-h-screen p-4">
                    <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
                        ...
                        <h1 class="text-3xl font-black text-green-700 mb-2">Â¡Orden Aprobada!</h1>
                        <p class="text-gray-600 mb-6">Su firma ha sido guardada exitosamente.</p>
                        
                        <div class="bg-green-50 rounded-xl p-4 mb-6">
                            <p class="text-sm text-gray-600">Orden NÂ°</p>
                        ...
                        <a href="https://wa.me/56939026185?text=\${encodeURIComponent('Hola, he aprobado la orden de trabajo #' + numeroOrden + '. Mi patente es: ' + '${orden.patente_placa}')}" 
                           ...
                           class="block w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 rounded-xl mb-3 transition">
                            ðŸ“± Enviar ConfirmaciÃ³n al Taller
                        </a>
                        ...
                        <p class="text-sm text-gray-500 mt-4">SerÃ¡ redirigido en 5 segundos...</p>
                    </div>
...
<body class="bg-green-100 flex items-center justify-center min-h-screen p-4">
    <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
        ...
        <div class="bg-green-50 rounded-xl p-4 mb-6">
            <p class="text-sm text-gray-600">Orden NÂ°</p>
            <p class="text-2xl font-bold text-green-700">${numeroOrden}</p>
            <p class="text-xs text-gray-500 mt-2">Fecha de aprobaciÃ³n: ${orden.fecha_aprobacion || 'N/A'}</p>
        </div>
...
<body class="bg-red-100 flex items-center justify-center min-h-screen p-4">
    <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
        <div class="text-8xl mb-4">âŒ</div>
        ...
        <div class="bg-red-50 rounded-xl p-4 mb-6">
            ...
            <p class="text-xs text-gray-500 mt-2">Fecha de cancelaciÃ³n: ${orden.fecha_cancelacion || 'N/A'}</p>
        </div>
