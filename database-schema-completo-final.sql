...
INSERT INTO Configuracion (id, ultimo_numero_orden) VALUES (1, 57);
...
-- Índices de Tecnicos
CREATE INDEX idx_tecnicos_telefono ON Tecnicos(telefono);
...
CREATE INDEX idx_vehiculos_patente ON Vehiculos(patente_placa);
CREATE INDEX idx_vehiculos_cliente ON Vehiculos(cliente_id);

-- Índices de OrdenesTrabajo
CREATE INDEX idx_ordenes_numero ON OrdenesTrabajo(numero_orden);
CREATE INDEX idx_ordenes_patente ON OrdenesTrabajo(patente_placa);
CREATE INDEX idx_ordenes_estado ON OrdenesTrabajo(estado);
CREATE INDEX idx_ordenes_cliente ON OrdenesTrabajo(cliente_id);
CREATE INDEX idx_ordenes_vehiculo ON OrdenesTrabajo(vehiculo_id);
CREATE INDEX idx_ordenes_token ON OrdenesTrabajo(token);
